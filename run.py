...
class BertBase(object):
    ...
    def main(self):
        ...
        #     train_D = DataGenerator(tokenizer=tokenizer, data=[x1, x2, y], batch_size=8, MAX_LEN=self.MAX_LEN)
        ...
        val_y = labels[valid_index]
        val_cat = labels_cat[valid_index]
        train_D = DataGenerator(tokenizer=tokenizer, data=[x1, x2, y], batch_size=10, MAX_LEN=self.MAX_LEN)
